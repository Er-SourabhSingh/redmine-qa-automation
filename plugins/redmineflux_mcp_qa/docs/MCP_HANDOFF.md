# Handoff — Redmineflux MCP Server
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/redmineflux-mcp/
- `MCP_REQUIREMENTS.md`, `MCP_FEATURES_LIST.md` and `MCP_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
