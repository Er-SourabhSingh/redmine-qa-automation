# Bug Index — Redmineflux Lotus Theme

| Bug ID | Title | Status | Severity | Redmine Version | File Path |
|--------|-------|--------|----------|-----------------|-----------|
| BUG-LTS-001 | Longer German admin-sidebar labels clipped with an ellipsis under Lotus theme, render fully under Default | Closed | Medium | 7.0.1.stable | bugs/closed/BUG-LTS-001.md |
| BUG-LTS-002 | [INVALIDATED] Issue detail tab strip appeared to clip tab labels at 1280×720 — confirmed working "peek of next tab" scroll affordance, every tab reachable in full via the "<"/">" controls | Closed | N/A | 7.0.1.stable | bugs/closed/BUG-LTS-002.md |
| BUG-LTS-003 | [Closed 2026-09-18] Sprint/Story-Points integration under Lotus — Tags-widget overlap, value overlap, and font/bullet mismatch all fixed; edit-form full-width layout (no overlap, cosmetic only) accepted as minor per user judgment | Closed | Medium | 7.0.1.stable | bugs/closed/BUG-LTS-003.md |
