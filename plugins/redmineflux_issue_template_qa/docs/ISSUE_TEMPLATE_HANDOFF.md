# Handoff — Redmineflux Issue Template Plugin
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/issue-template-plugin/
- `ISSUE_TEMPLATE_REQUIREMENTS.md`, `ISSUE_TEMPLATE_FEATURES_LIST.md` and `ISSUE_TEMPLATE_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
