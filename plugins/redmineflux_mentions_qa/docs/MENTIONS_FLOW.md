# Plugin Flow — Redmineflux Mentions Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/mentions-plugin/
...
3. Administration → Plugins → Redmineflux Mentions Plugin → Configure.
