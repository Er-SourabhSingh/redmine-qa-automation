...
- **BUG-TCM-003 and BUG-TCM-004 both retested PASS on 2026-09-15** after the developer switched branch on `localhost:3010`. Kept in `bugs/open/` deliberately: `SENIOR_QA_STANDARDS.md` §26 gates closure on the affected-suite regression, and `TESTCASE_MANAGEMENT_TEST_RUNS.md` (TC-TCM-152–440) has never been executed. Production #120544 / #120546 unchanged until that runs.
