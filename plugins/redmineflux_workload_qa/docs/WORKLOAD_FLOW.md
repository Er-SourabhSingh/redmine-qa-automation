# Plugin Flow — Redmineflux Workload Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/workload-plugin/
...
3. Administration → Plugins → Redmineflux Workload Plugin → Configure.
