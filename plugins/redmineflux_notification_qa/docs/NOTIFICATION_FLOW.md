# Plugin Flow — Redmineflux Notification Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/notification/
...
3. Administration → Plugins → Redmineflux Notification Plugin → Configure.
