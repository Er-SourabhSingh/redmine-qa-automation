...
- Duplicate found: No (checked `bugs/_duplicates.md` — empty register; this scenario, a customer entitled to multiple projects emailing a specific one's mailbox, was never previously tested — confirmed via a project-wide grep for "custom field"-adjacent and email-routing terms before writing TC-HLP-402)
