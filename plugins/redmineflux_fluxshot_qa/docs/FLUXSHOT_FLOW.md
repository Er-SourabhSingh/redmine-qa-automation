# Plugin Flow — Fluxshot Chrome Extension

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/fluxshot-chrome-extension/
...
3. Administration → Plugins → Fluxshot Chrome Extension → Configure.
