...
- Result: **FIXED**
- Push webhook with 3 commits (SHAs: `aaa001...`, `bbb001...`, `ccc001...`) and `repository.html_url` included → HTTP 202 (event_id: 254). After 3s, all 3 commits found in `/projects/phoenix-platform/devops_commits.json` (total_count increased by 3). Multi-commit background job no longer fails with RecordInvalid. Bug no longer reproduces.
