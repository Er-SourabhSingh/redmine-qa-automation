# Plugin Flow — Redmineflux Invoice Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/invoice/
...
3. Administration → Plugins → Redmineflux Invoice Plugin → Configure.
