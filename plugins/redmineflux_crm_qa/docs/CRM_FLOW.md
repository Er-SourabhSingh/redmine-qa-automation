# Plugin Flow — Redmineflux CRM Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/crm/
...
3. Administration → Plugins → Redmineflux CRM Plugin → Configure.
