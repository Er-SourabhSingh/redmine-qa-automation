# Plugin Flow — Redmineflux Issue Template Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/issue-template-plugin/
...
3. Administration → Plugins → Redmineflux Issue Template Plugin → Configure.
