...
- **RE-CONFIRMED LIVE 2026-08-31** (Local, redmine-docker-6, post-DB-reset): PASS, evidenced by this session's own re-runs — ticket #5 (TC-HLP-013, global Command Center), #6 (TC-HLP-014, project-scoped form), and #8 (TC-HLP-016, created by email) all showed Status "New" immediately after creation, across all three creation methods. No separate repro needed.
...
### TC-HLP-040: A customer's portal session can never see internal or private notes, under any configuration
