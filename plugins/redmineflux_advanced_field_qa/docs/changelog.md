...
|------|-----------------|-------------|-----------|---------|
| 2026-05-21 | 6.0.9.stable | Forge | Admin (Playwright/Claude) | Executed all positive test cases TC-RAF-001 through TC-RAF-043. 47 PASS, 0 FAIL, 4 BLOCKED (BUG-RAF-001). 2 bugs found: BUG-RAF-001 (dependency rule limit) High, BUG-RAF-002 (integer formula float validation) High. All formula types, sequence, dependency, and visibility rules verified. |
