...
2. Find a ticket whose SLA is currently between roughly 20% and 50% of its total response/resolution window remaining — e.g. ticket #34 ("TC-HLP-358 ticket assigned during the holiday itself test"), which showed **"13h 33m At Risk"** (amber dot) in the SLA Status column.
