# Handoff — Redmineflux CRM Plugin
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/crm/
- `CRM_REQUIREMENTS.md`, `CRM_FEATURES_LIST.md` and `CRM_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
