...
- Result: **CONFIRMED**
- Checked deployment detail pages #7, #8, #9 for "Issues Included" section — not found on any. Deployment detail shows only: VERSION, ENVIRONMENT, DEPLOYED BY, COMMIT, PROVIDER, DURATION, STARTED, FINISHED, POST-DEPLOY HEALTH, DESCRIPTION. No linked issues section. Bug persists.
...
- Result: **CONFIRMED**
- Checked deployment detail pages for agileboard. Deployment detail shows: VERSION, ENVIRONMENT, DEPLOYED BY, COMMIT, PROVIDER, DURATION, STARTED, FINISHED, POST-DEPLOY HEALTH, DESCRIPTION. No "Issues Included" or linked issues section. Bug persists.
