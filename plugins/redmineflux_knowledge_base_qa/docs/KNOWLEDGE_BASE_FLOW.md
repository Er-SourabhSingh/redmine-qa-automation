# Plugin Flow — Redmineflux Knowledge Base Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/knowledge-base-plugin/
...
3. Administration → Plugins → Redmineflux Knowledge Base Plugin → Configure.
