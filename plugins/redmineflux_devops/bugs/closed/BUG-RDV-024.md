...
- Result: **FIXED**
- Navigated to `/projects/phoenix-platform/devops_builds`. Filter form now contains `date_from` and `date_to` date picker fields in addition to the period preset dropdown. Custom date range inputs are present. Bug no longer reproduces.
