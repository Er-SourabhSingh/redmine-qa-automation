# Handoff — Redmineflux Knowledge Base Plugin
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/knowledge-base-plugin/
- `KNOWLEDGE_BASE_REQUIREMENTS.md`, `KNOWLEDGE_BASE_FEATURES_LIST.md` and `KNOWLEDGE_BASE_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
