# Handoff — Redmineflux Invoice Plugin
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/invoice/
- `INVOICE_REQUIREMENTS.md`, `INVOICE_FEATURES_LIST.md` and `INVOICE_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
