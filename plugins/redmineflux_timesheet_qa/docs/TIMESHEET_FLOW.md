# Plugin Flow — Redmineflux Timesheet Plugin

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/timesheet/
...
3. Administration → Plugins → Redmineflux Timesheet Plugin → Configure.
