...
- Result: **FIXED**
- All 5 previously-failing endpoints now return HTTP 200: devops_environments.json → 200, devops_incidents.json → 200, devops_vulnerabilities.json → 200, devops_releases.json → 200, devops_alerts.json → 200. JSON responders have been registered for all 5 controllers. Bug no longer reproduces.
