# Handoff — Redmineflux Notification Plugin
...
- Vendor knowledge base ingested from https://www.redmineflux.com/knowledge-base/plugins/notification/
- `NOTIFICATION_REQUIREMENTS.md`, `NOTIFICATION_FEATURES_LIST.md` and `NOTIFICATION_USER_GUIDE.md` populated from the KB, clearing the
  §11 pre-test blocker.
