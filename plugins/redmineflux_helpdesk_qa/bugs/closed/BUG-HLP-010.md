...
- **Note for whoever updates the requirements/test docs**: `HELPDESK_USER_GUIDE.md` §3.4 and `testcases/HELPDESK_FIELD_VALIDATIONS.md` TC-HLP-292 both currently describe the old (permissive) behavior as correct/expected — both need updating now that Website/Phone are enforced unique, per this bug's own original Notes section anticipating exactly this follow-up.
...
- `HELPDESK_USER_GUIDE.md` §3.4 and TC-HLP-292 still need their own updates to reflect this — not done as part of this closure, tracked separately.
