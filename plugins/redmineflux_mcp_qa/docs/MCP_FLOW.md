# Plugin Flow — Redmineflux MCP Server

> Key end-user flows used for test design. Derived from https://www.redmineflux.com/knowledge-base/plugins/redmineflux-mcp/
...
3. Administration → Plugins → Redmineflux MCP Server → Configure.
